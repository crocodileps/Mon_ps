...
export default function StrategiesPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch improvements (endpoint à créer)
                ...
                {improvements.slice(0, 3).map((improvement) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <button onClick={() => router.push(`/strategies/improvements/${improvement.id}`)} className="px-3 py-1 bg-violet-500/20 hover:bg-violet-500/30 rounded text-violet-400 font-semibold transition-all flex items-center gap-1">
                        Détails
