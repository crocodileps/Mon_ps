...
import { BarChart3, TrendingUp, Activity, Zap, Menu, X, Settings, LayoutDashboard, Lightbulb, FolderKanban, Layers, Calculator, Car, Brain } from 'lucide-react'
...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/strategy-v2', label: 'Strategy V2', icon: Brain },
  ]
