...
class OpportunityResponse(BaseModel):
    ...
    outcome: str
    best_odd: Decimal
    worst_odd: Optional[Decimal] = None
    spread_pct: float
    bookmaker_best: str
...
class Stats(BaseModel):
    ...
    bankroll: Optional[BankrollSummary] = None
    by_bookmaker: Optional[Dict[str, Any]] = None
    by_bet_type: Optional[Dict[str, Any]] = None
    by_market: Optional[Dict[str, Any]] = None
    recent_bets: Optional[List[BetInDB]] = None
