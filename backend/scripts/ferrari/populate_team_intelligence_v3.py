...
ALERT_RULES = {
    ...
    "btts_yes": [
        ...
        {"field": "clean_sheet_rate", "op": ">=", "val": 45, "level": "CAUTION",
         "msg": "{val:.0f}% clean sheets", "alt": "btts_no"},
    ],
    "btts_no": [
        {"field": "btts_rate", "op": ">=", "val": 70, "level": "TRAP",
         "msg": "{val:.0f}% BTTS", "alt": "btts_yes"},
        {"field": "btts_rate", "op": ">=", "val": 60, "level": "CAUTION",
         "msg": "{val:.0f}% BTTS", "alt": "btts_yes"},
    ],
    "over_25": [
        {"field": "avg_goals_total", "op": "<=", "val": 1.8, "level": "TRAP",
         "msg": "Moyenne {val:.1f} buts", "alt": "under_25"},
        {"field": "over_25_rate", "op": "<=", "val": 30, "level": "CAUTION",
    ...
    "home": [
        {"field": "home_win_rate", "op": "<=", "val": 20, "level": "TRAP",
         "msg": "{val:.0f}% victoires dom", "alt": "dc_1x"},
        {"field": "home_win_rate", "op": "<=", "val": 30, "level": "CAUTION",
         "msg": "{val:.0f}% victoires dom", "alt": "dc_1x"},
    ],
    "away": [
        {"field": "away_win_rate", "op": "<=", "val": 10, "level": "TRAP",
         "msg": "{val:.0f}% victoires ext", "alt": "draw"},
        {"field": "away_win_rate", "op": "<=", "val": 20, "level": "CAUTION",
         "msg": "{val:.0f}% victoires ext", "alt": "draw"},
    ],
}
